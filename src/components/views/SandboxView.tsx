...
const difficultyConfig: Record<TrainingModule['difficulty'], DifficultyConfig> = {
  beginner:     { label: 'Beginner',   color: '#16a34a', bg: 'rgba(22,163,74,0.1)', border: 'rgba(22,163,74,0.25)' },
  intermediate: { label: 'Intermediate', color: '#d97706', bg: 'rgba(217,119,6,0.1)', border: 'rgba(217,119,6,0.25)' },
  advanced:     { label: 'Advanced',   color: '#dc2626', bg: 'rgba(220,38,38,0.1)', border: 'rgba(220,38,38,0.25)' },
};
